...
filterLessThan50Btn.addEventListener("click", async function () {
  ...
  try {
    let data = await fetch(
      `https://flipkart-clone-server-exd0.onrender.com/Electric`
    );
...
sortAtoZBtn.addEventListener("click", function () {
  let url = `https://flipkart-clone-server-exd0.onrender.com/Electric?_sort=finalPrice&_order=asc`;
  init(url);
});
sortZtoABtn.addEventListener("click", function () {
  let url = `https://flipkart-clone-server-exd0.onrender.com/Electric?_sort=finalPrice&_order=desc`;
  init(url);
});

let url = `https://flipkart-clone-server-exd0.onrender.com/Electric`;

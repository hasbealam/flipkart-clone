...
filterLessThan50Btn.addEventListener("click", async function () {
  ...
  try {
    let data = await fetch(
      `https://flipkart-clone-server-exd0.onrender.com/clots`
    );
...
function topp(data) {
  ...
  data.map(function (elem, index) {
    ...
    divpricebox.append(divfinalprice, divmrp, divdiscount);
...
sortAtoZBtn.addEventListener("click", function () {
  let url = `https://flipkart-clone-server-exd0.onrender.com/clots?_sort=finalPrice&_order=asc`;
  init(url);
});
sortZtoABtn.addEventListener("click", function () {
  let url = `https://flipkart-clone-server-exd0.onrender.com/clots?_sort=finalPrice&_order=desc`;
  init(url);
});

let url = `https://flipkart-clone-server-exd0.onrender.com/clots`;
